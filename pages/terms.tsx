      ...
      <Layout color='yellow'>
        <section className='mx-[25%] my-[5%]'>
          ...
          <p>
            ...
            use of PointWall&apos;s Website, located at pointwall.com.ar.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use PointWall if you do not agree to
          ...
          <p>
            We employ the use of cookies. By accessing PointWall, you agreed to
            use cookies in agreement with the PointWall&apos;s Privacy Policy.{' '}
          </p>
          ...
          <p>
            Unless otherwise stated, PointWall and/or its licensors own the
            intellectual property rights for all material on PointWall. All
            intellectual property rights are reserved. You may access this from
            PointWall for your own personal use subjected to restrictions set in
          ...
          <p>
            ...
            PointWall does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of PointWall,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, PointWall
          ...
          <p>
            PointWall reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant PointWall a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of PointWall;
          ...
          <p>
            ...
            sending an e-mail to PointWall. Please include your name, your
          ...
          <p>
            No use of PointWall&apos;s logo or other artwork will be allowed for
