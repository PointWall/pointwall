      ...
      <Layout color='green'>
        <Wrapper>
          <section className='text-center'>
            ...
            <div className='max-w-screen-md min-w-[200px] md:w-3/4 aspect-video mx-auto mt-16 relative'>
          ...
          <section>
            <div className='border-red-300 border-l-4 pl-4 my-10'>
              ...
              <p className='my-4'>
                Uno de esos mapas relevados fue el de Murales, el cual tomó otro rumbo, y se transformó en PointWall.
              </p>
            </div>
            <div className='border-orange-300 border-l-4 pl-4 my-10'>
              ...
              <ol className='my-4 list-decimal pl-8'>
                <li>Comenzamos a idealizar las bases de PointWall, qué busca, cómo realizar el proyecto y cómo ponerlo en práctica.</li>
                <li>Luego, realizamos los primeros boocetos sobre cómo se iba a ver PointWall, y el enfoque que tendría.</li>
            ...
            <div className='border-yellow-300 border-l-4 pl-4 my-10'>
              ...
              <p className='my-4'>
                ...
                Una nueva forma para todos aquellos que quieran hallar de fácil y sencillamente los murales, grafitis, etc.
              </p>
            ...
            <div className='border-lime-300 border-l-4 pl-4 my-10'>
              ...
              <p className='my-4'>
                ...
                Encontrar una forma fácil, sencilla y ágil de los mapas, es lo que busca ser PointWall.<br />
                Ser un servicio que busca colaboradores todo el tiempo, para poder expandir la cantidad de murales que se encuentran en PointWall.
              </p>
            </div>
            <div className='max-w-screen-md min-w-[200px] md:w-3/4 aspect-video mx-auto my-16 relative'>
